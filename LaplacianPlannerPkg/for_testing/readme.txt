Packaging and Deploying LaplacianPlannerPkg
...
2. Installing the LaplacianPlannerPkg Package

A. Go to the directory that contains the file setup.py and the subdirectory 
   LaplacianPlannerPkg. If you do not have write permissions, copy all its contents to a 
...
3. Using the LaplacianPlannerPkg Package

The LaplacianPlannerPkg package is on your Python path. To import it into a Python script 
   or session, simply execute:

    import LaplacianPlannerPkg
